          ...
          bslib::accordion(
            bslib::accordion_panel(
              ...
              fluidRow(
                column(
                  width = 4,
                  numericInput(inputId = ns("height_id"), label = "Adjust Plot Height", value = 6, min = 1, max = 30, step = 1)
                ),
                column(
                  width = 4,
                  numericInput(inputId = ns("width_id"), label = "Adjust Plot Width", value = 6, min = 1, max = 30, step = 1)
                ),
                column(
                  width = 4,
